...
import com.example.supermarketpetproject.productlist.presentation.ProductListUiState

@Composable
fun FiltersMenu(state: ProductListUiState.Success, onCategorySelected: (String?) -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
